                                        ...
                                        const vector<Blob<Dtype>*>& top) 
{
  ...
  if (use_global_stats_) 
  {
    ...
    caffe_cpu_scale(variance_.count(), 
                    scale_factor,
  ...
  // normalize variance
  caffe_add_scalar(variance_.count(), 
                   eps_, 
                   variance_.mutable_cpu_data());

  caffe_powx(variance_.count(), 
             variance_.cpu_data(), 
             Dtype(0.5),
             variance_.mutable_cpu_data());
