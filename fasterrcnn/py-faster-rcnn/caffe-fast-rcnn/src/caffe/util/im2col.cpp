                 ...
                 Dtype* data_col) 
{
    ...
    std::cout << "(util::im2col_cpu) output_h = (height + 2 * pad_h - (dilation_h * (kernel_h - 1) + 1)) / stride_h + 1 = " 
              << output_h << std::endl;
    std::cout << "(util::im2col_cpu) output_w = (width + 2 * pad_w - (dilation_w * (kernel_w - 1) + 1)) / stride_w + 1 = " 
              << output_w << std::endl;
...
template <typename Dtype>
void im2col_nd_cpu(const Dtype* data_im, 
                   const int num_spatial_axes,
                   const int* im_shape, 
                   const int* col_shape,
                   const int* kernel_shape, 
...
template <typename Dtype>
void col2im_nd_cpu(const Dtype* data_col, 
                   const int num_spatial_axes,
                   const int* im_shape, 
                   const int* col_shape,
                   const int* kernel_shape, 
